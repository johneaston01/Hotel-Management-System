...
{
	var tariff=document.getElementsByName("room");
	if((tariff[0].checked==false)&&(tariff[1].checked==false)&&(tariff[2].checked==false)&&(tariff[3].checked==false)&&(tariff[4].checked==false))
		{
        ...
        if(document.tariff.fdate.value != "") {
          if(regs1 = document.tariff.fdate.value.match(re)) {
       ...
       //     form.startdate.focus();
        ...
        if(document.tariff.tdate.value != "") {
          if(regs2 = document.tariff.tdate.value.match(re)) {
            // day value between 1 and 31
